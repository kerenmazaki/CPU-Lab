...
KEY1_ISR: sw   $t0,0x804 # write to PORT_HEX0[7-0]
...
KEY2_ISR: sw   $t0,0x808 # write to PORT_HEX2[7-0]
...
KEY3_ISR: sw   $t0,0x80C # write to PORT_HEX4[7-0]
